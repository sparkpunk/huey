<template>
  <div class="flex flex-col absolute inset-y-0 left-0 w-56 overflow-y-scroll p-8 text-gray-800 border-r border-gray-100">
    <form @submit.prevent="">
      <div class="mb-4">
        <div class="flex">
        ...
        class="group flex items-center justify-center w-full mt-4 py-2 px-4 text-xs font-bold text-white rounded-xl transition-shadow duration-200 hover:shadow focus:ring-0 focus:outline-none">
          <svg class="w-6 h-6 -ml-3 mr-3 fill-current transform group-hover:-ml-1 group-hover:mr-1 group-hover:rotate-360 transition-all duration-200" viewBox="0 0 24 21" xmlns="http://www.w3.org/2000/svg">
